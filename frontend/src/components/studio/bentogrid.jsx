...
const items = [
  {
    ...
    description: "Create your podcast with ease.",
    header: <Skeleton />,
    icon: <IconClipboardCopy className="h-4 w-4 text-neutral-500" />,
  },
  {
    title: "Join The Podcast",
    description: "Hey Guest! Dive into the transformative power of technology.",
    header: <Skeleton />,
  ...
  {
    title: "Download Your Podcasts",
    description: "Listen and share your creations with the world.",
    header: <Skeleton />,
